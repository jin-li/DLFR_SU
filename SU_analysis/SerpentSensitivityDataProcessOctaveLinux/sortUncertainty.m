...
[commaraRowReaction,commaraRowNuclide,commaraColumnReaction,commaraColumnNuclide]=textread([indexdir,'/commaraMatrix.index'],'%*d %s %s %s %s');
...
unc_recdf6 = fopen([tempdir,'/totalUncertainty.result'], 'wt');
